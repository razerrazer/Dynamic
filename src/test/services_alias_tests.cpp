...
BOOST_AUTO_TEST_CASE (generate_aliasmultiupdate)
{
	...
	BOOST_CHECK_THROW(r = CallRPC("node1", "aliasupdate jagmultiupdate changedata1"), runtime_error);
	...
	BOOST_CHECK_THROW(r = CallRPC("node2", "aliasupdate jagmultiupdate changedata4"), runtime_error);
	...
	BOOST_CHECK_THROW(r = CallRPC("node1", "aliasupdate jagmultiupdate changedata9"), runtime_error);
...
BOOST_AUTO_TEST_CASE (generate_aliaspay)
{
	...
	BOOST_CHECK_THROW(r = CallRPC("node2", "aliasupdate alias2.aliaspay.tld changedata2"), runtime_error);
	...
	BOOST_CHECK_THROW(r = CallRPC("node3", "aliasupdate alias3.aliaspay.tld changedata3"), runtime_error);
	GenerateBlocks(10, "node1");
	GenerateBlocks(10, "node2");
	GenerateBlocks(10, "node3");
}
...
BOOST_AUTO_TEST_CASE (generate_aliasexpiredbuyback)
{
	...
	BOOST_CHECK(hex_str.empty());
	BOOST_CHECK_THROW(CallRPC("node2", "aliasnew aliasexpirebuyback"), runtime_error);
	BOOST_CHECK_THROW(CallRPC("node1", "aliasnew aliasexpirebuyback"), runtime_error);
...
BOOST_AUTO_TEST_CASE (generate_aliasexpired)
{
	...
	BOOST_CHECK_THROW(CallRPC("node2", "escrownew false aliasexpire2node2 aliasexpirednode2 " + offerguid + " 1 " + " true 0"), runtime_error);
	// should fail: new escrow with expired alias
	BOOST_CHECK_THROW(CallRPC("node2", "escrownew false aliasexpirednode2 aliasexpire " + offerguid + " 1 " + " true 0"), runtime_error);

	BOOST_CHECK_NO_THROW(r = CallRPC("node1", "aliasupdate aliasexpire newdata1"));
	...
	BOOST_CHECK_NO_THROW(r = CallRPC("node1", "aliasupdate aliasexpire2 changedata1 " + aliasexpire2node2address));
	...
	BOOST_CHECK_NO_THROW(r = CallRPC("node2", "aliasupdate aliasexpire2 changedata1 " + aliasexpire2node2address));
	...
	BOOST_CHECK_THROW(CallRPC("node1", "certnew aliasexpire2 jag1 pubdata"), runtime_error);
